...
anon_user_patch = patch(
    "flask_security.decorators.anonymous_user_required", lambda f: f
)
...
def test_login_existing_user_found_by_username(
    configured_app,
    mock_server_factory,
    ...
    def inner(mock_db):
        with app.test_request_context():
            ...
            assert (
                b'<a href="/bikini/bottom/">/bikini/bottom/</a>. If not, click the link.\n'
