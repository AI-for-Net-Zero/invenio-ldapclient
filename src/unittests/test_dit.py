...
from invenio_ldapclient.dit import (_ldap_anon_connection,
...
RequestObject = type('RequestObject', (), {'get_username': lambda:None,
...
def test_bind_fail():
    ...
    @patch('invenio_ldapclient.dit._get_entry_and_try_rebind', mock__get_entry_and_try_rebind)
